...
public class TestSelenium_29_Complex_Windows {
    ...
    public void test_actions() throws  InterruptedException {
        ...
        String parnetWindowHandle = driver.getWindowHandle();
        System.out.println("Parent ->" + parnetWindowHandle);
        ...
        for(String handle: allHandles){
         if(!handle.equals(parnetWindowHandle)){
